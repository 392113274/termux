...
wget -O ~/proxypool-$last_version/config/config.yaml https://raw.githubusercontent.com/392113274/termux/main/config.yaml
wget -O ~/proxypool-$last_version/config/source.yaml https://raw.githubusercontent.com/392113274/termux/main/source.yaml
